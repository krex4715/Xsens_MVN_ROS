        ...
        if len(data) == 760:
            ...
            try:
                ...
                for i in range(0,23):
                    ...
                    print(mymsg)
                    # print(struct.unpack('!f',data[strstep+60:strstep+64])[0])
                    # print(struct.unpack('!f',data[strstep+64:strstep+68])[0])
                    # print(struct.unpack('!f',data[strstep+68:strstep+72])[0])
